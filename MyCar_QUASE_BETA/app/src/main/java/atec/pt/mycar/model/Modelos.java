...
public class Modelos {
    String imagem_modelo,nome_marca, nome_modelo,id,username,
            nr_portas,combustivel,consumo,potencia,matricula,motor;

    public Modelos() {
    }

    public Modelos(String imagem_modelo, String nome_marca, String nome_modelo, String id, String username, String nr_portas, String combustivel, String consumo, String potencia, String matricula, String motor) {
